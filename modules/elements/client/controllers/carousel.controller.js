...
(function() {
    ...
    AngularCarouselController.$inject=['$scope'];
    function AngularCarouselController($scope) {
        var vm = this;
        ...
        //   $scope.content='<div class="panel-wrapper" uib-collapse="panelResident">'+
        //   '<div class="panel-body">'+
        //   '<p>용도 : '+ '상업용' +'</p>'+
        //   '<p> 평균 일간 전력사용량 : '+'50Kwh'+'</p>'+
        //   '<p> 평균 일간 신재생발전량 : '+'50Kwh'+'</p>'+
        //   '<p> 평균 월간 전력사용량 : '+'50Kwh'+'</p>'+
        //   '<p> 평균 월간 신재생발전량 : '+'50Kwh'+'</p>'+
        //   '</div>'+
        //   '</div>';
