 ...
 'use strict';   
      exports.getYesterday=function(date){
        ...
        var day = '' + (d.getDate()-1); if (day.length == 1) { day = '0' + day; }
        return year + '-' + month + '-' + day;
      };

      exports.yyyymmddhhmmss = function (date) {
      ...
      exports.yyyymmddhhmm = function (date) {
        var now = new Date(date);
        var year = '' + now.getFullYear();
        var month = '' + (now.getMonth() + 1); if (month.length == 1) { month = '0' + month; }
        var day = '' + now.getDate(); if (day.length == 1) { day = '0' + day; }
      ...
      exports.yyyymmdd_7 = function(date){
        var now = new Date(date);
      ...
      exports.isSolarHoliday = function (date) {
      ...
      exports.isLunarHoliday = function (date) {
      ...
      exports.isWeekends = function (date) {
        var now = new Date(date);
        var day = '' + now.getDate(); if (day.length == 1) { day = '0' + day; }
      ...
      exports.needAlternativeHoliday = function(date){
      ...
      exports.latestdays_end_yyyymmdd = function(date,pre){
        var now = new Date(date);
      ...
      exports.latestdays_start_yyyymmdd = function(date,pre){
        var now = new Date(date);
      ...
      exports.latestdays_yyyymmdd = function(paramdate){
      ...
      exports.mmIndexTohhmm = function(index){
      ...
      //count수 만큼 이전날 가져옴
      exports.PreviousDay = function(date,count){
        var temp = new Date(date);
        var predate = new Date();
        var predateArray=[];
        
        for(var i=1; i<=count; i++){
          predate.setDate(temp.getDate()-i);
          ...
          predateArray.unshift(year + '-' + month + '-' + day);
        }
        
        return predateArray;
      };
      //date 바로 전날만 가져옴
      exports.PreviousDay_One = function(date){
        // var temp = new Date(date);
      ...
      exports.PreviousMonth=function(date){
        var temp = new Date(date);
      ...
      //사이트별 일간 전력/생산량 평균값을 구하기 위해 일수 필요 
      exports.preMonth = function (date) { //금년 전달
        var temp = new Date(date);
        var obj = new Object();
        var predate = new Date(temp.setMonth(temp.getMonth() - 1));
        var year = predate.getFullYear();
        ...
        obj.date = year + '-' + month + '-' + '%'; //전달
        obj.lastDay = (new Date(year, month, 0)).getDate(); //전달 마지막일
        // return year + '-' + month + '-' + '%';
        return obj;
      };
      exports.preYear = function (date) {
        var temp = new Date(date);
      ...
      exports.PreviousMonthfirstday=function(date){//전달의 1일
        var temp = new Date(date);
        var predate = new Date(temp.setMonth(temp.getMonth() - 1));
        var year = '' + predate.getFullYear();
        var month = '' + (predate.getMonth() + 1); if (month.length == 1) { month = '0' + month; }
      ...
      exports.firstDay=function(date){//이번달의 1일
        var temp = new Date(date);
