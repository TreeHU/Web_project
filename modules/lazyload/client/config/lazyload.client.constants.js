(function() {
    ...
    angular
        ...
        .constant('APP_REQUIRES', {
          ...
          scripts: {
            'navermap':           ['https://openapi.map.naver.com/openapi/v3/maps.js?clientId=EemAd3sER3AslD3zSJUG'],
          ...
          modules: [
            {name: 'nvd3',                   files: ['/lib/d3/d3.js',
                                                  '/lib/nvd3/build/nv.d3.js',
                                                  '/lib/angular-nvd3/dist/angular-nvd3.js',
                                                  '/lib/nvd3/build/nv.d3.css'],
                                                  serie: true},
            {name: 'ng-jsoneditor',          files: ['/lib/jsoneditor/dist/jsoneditor.min.js',
                                                    '/lib/jsoneditor/dist/jsoneditor.min.css',
                                                    '/lib/ng-jsoneditor/ng-jsoneditor.js'], serie: true},
            ...
            {name: 'angular-autocomplete',      files: ['/lib/underscore/underscore-min.js',
                                                        '/lib/angular-auto-complete/angular-auto-complete.css',
                                                        '/lib/angular-auto-complete/angular-auto-complete.js'], serie: true},
            ...
            {name: 'oitozero.ngSweetAlert',     files: ['/lib/sweetalert/src/sweetalert.css',
                                                        '/lib/sweetalert/src/sweetalert.min.js',
            ...
            {name: 'chart.js',                  files: ['/lib/chart.js/dist/Chart.bundle.js',
                                                        '/lib/chart.js/dist/Chart.bundle.min.js',
                                                        '/lib/chart.js/dist/Chart.js',
                                                        '/lib/chart.js/dist/Chart.min.js',
                                                        '/lib/angular-chart.js/dist/angular-chart.min.js'], serie: true},
            {name : 'c3',                       files:['/lib/c3/c3.min.js',
                                                       '/lib/c3/c3.js',
                                                       '/lib/c3/c3.css'], serie : true},
            {name : 'd3',                       files:['/lib/d3/d3.min.js',
                                                       '/lib/d3/d3.js'], serie : true}
