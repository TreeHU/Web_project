 ...
 exports.minusHours=function(date,hour){
   var d= new Date(date);
   var newHour;
 ...
 exports.isLunarHoliday = function (date) {
   ...
   if(lunar.lunarMonth===1){
    //설날 다음날
    if(lunar.lunarDay===2) return true;
  }
   ...
   if(lunar.lunarMonth===8){
    //추석-1
    if(lunar.lunarDay===14) return true;
  }
   if(lunar.lunarMonth===8){
     //추석
   ...
   if(lunar.lunarMonth===8){
    //추석+1
    if(lunar.lunarDay===16) return true;
  }
   if(lunar.lunarMonth===12){
    //설날
    if(lunar.lunarDay===30) return true;
  }
 ...
 exports.PreviousDay_One = function(date){
   ...
   var predate = new Date(date);
     ...
     predate.setDate(temp.getDate()-1);
     var year = '' + predate.getFullYear();
     var month = '' + (predate.getMonth() + 1); if (month.length == 1) { month = '0' + month; }
     var day = '' + predate.getDate(); if (day.length == 1) { day = '0' + day; }
...
exports.timeToIndex= function(date) {
